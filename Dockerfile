...
CMD wget https://localtonet.com/download/localtonet-linux-x64.zip
CMD unzip localtonet-linux-x64.zip
CMD chmod 777 ./localtonet
CMD ./localtonet authtoken OyuCiHePFb7DtxGkVNfwal6goR23A4JqX
